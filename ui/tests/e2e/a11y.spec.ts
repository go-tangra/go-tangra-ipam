...
// T070 / SC-006: every ipam view inside the shell, both themes, zero serious or
...
const routes = ['/ipam',  '/ipam/addresses',  '/ipam/devices',  '/ipam/vlans',  '/ipam/locations',  '/ipam/groups',  '/ipam/scans',  '/ipam/dashboard']

test.describe('ipam accessibility', () => {
