...
// The ipam UI is a federated remote served by the module under /ui/ and
// relayed by the gateway at /m/ipam/; `vite` alone runs a standalone dev
...
export default defineConfig({
  ...
  test: {
    environment: 'jsdom',
    environmentOptions: { jsdom: { url: 'https://localhost/ipam' } },
