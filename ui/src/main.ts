// Standalone development entry: mounts the ipam routes in a bare kit shell
...
const app = createApp({ render: () => h(UiAppShell, { title: 'ipam (dev)', hideNav: true }, () => h(RouterView)) })
app.use(createPinia())
