...
type DeviceQuery struct {
	...
	withInterfaces *DeviceInterfaceQuery
...
func (_q *DeviceQuery) QueryAddresses() *IpAddressQuery {
...
func (_q *DeviceQuery) QueryInterfaces() *DeviceInterfaceQuery {
...
func (_q *DeviceQuery) QueryLocation() *LocationQuery {
...
func (_q *DeviceQuery) WithAddresses(opts ...func(*IpAddressQuery)) *DeviceQuery {
	query := (&IpAddressClient{config: _q.config}).Query()
...
func (_q *DeviceQuery) WithInterfaces(opts ...func(*DeviceInterfaceQuery)) *DeviceQuery {
	query := (&DeviceInterfaceClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *DeviceQuery) WithLocation(opts ...func(*LocationQuery)) *DeviceQuery {
	query := (&LocationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *DeviceQuery) prepareQuery(ctx context.Context) error {
	...
	if device.Policy == nil {
		return errors.New("ent: uninitialized device.Policy (forgotten import ent/runtime?)")
	}
...
func (_q *DeviceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Device, error) {
	...
	if query := _q.withAddresses; query != nil {
		if err := _q.loadAddresses(ctx, query, nodes,
			func(n *Device) { n.Edges.Addresses = []*IpAddress{} },
			func(n *Device, e *IpAddress) { n.Edges.Addresses = append(n.Edges.Addresses, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withInterfaces; query != nil {
		if err := _q.loadInterfaces(ctx, query, nodes,
			func(n *Device) { n.Edges.Interfaces = []*DeviceInterface{} },
			func(n *Device, e *DeviceInterface) { n.Edges.Interfaces = append(n.Edges.Interfaces, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withLocation; query != nil {
		if err := _q.loadLocation(ctx, query, nodes, nil,
			func(n *Device, e *Location) { n.Edges.Location = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DeviceQuery) loadAddresses(ctx context.Context, query *IpAddressQuery, nodes []*Device, init func(*Device), assign func(*Device, *IpAddress)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(ipaddress.FieldDeviceID)
	}
	query.Where(predicate.IpAddress(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(device.AddressesColumn), fks...))
	}))
...
func (_q *DeviceQuery) loadInterfaces(ctx context.Context, query *DeviceInterfaceQuery, nodes []*Device, init func(*Device), assign func(*Device, *DeviceInterface)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Device)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(deviceinterface.FieldDeviceID)
	}
	query.Where(predicate.DeviceInterface(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(device.InterfacesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *DeviceQuery) loadLocation(ctx context.Context, query *LocationQuery, nodes []*Device, init func(*Device), assign func(*Device, *Location)) error {
...
func (_q *DeviceQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withLocation != nil {
			_spec.Node.AddColumnOnce(device.FieldLocationID)
		}
	}
